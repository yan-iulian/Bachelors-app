        ...
        <Provider store={store}>
            <BrowserRouter>
                ...
                <Routes>
                    ...
                    <Route path="/director/masini" element={
                        <AuthGuard roluriPermise={['Director']}>
                            <GestiuneMasini />
                        </AuthGuard>
                    } />
                    <Route path="/director/tranzactii" element={
                        <AuthGuard roluriPermise={['Director']}>
                            <Tranzactii />
                        </AuthGuard>
                    } />
                    <Route path="/director/test-drive" element={
                        <AuthGuard roluriPermise={['Director']}>
                            <CereriTestDrive />
                        </AuthGuard>
                    } />
                    <Route path="/director/discount" element={
                        <AuthGuard roluriPermise={['Director']}>
                            <CereriDiscount />
                        </AuthGuard>
                    } />
                    <Route path="/director/audit-log" element={
                        <AuthGuard roluriPermise={['Director']}>
                            <AuditLog />
                        </AuthGuard>
                    } />
                    <Route path="/director/reparatii" element={
                        <AuthGuard roluriPermise={['Director']}>
                            <AdaugaReparatie />
                        </AuthGuard>
                    } />
                    <Route path="/director/estimari" element={
                        <AuthGuard roluriPermise={['Director']}>
                            <EstimariReparatii />
                        </AuthGuard>
                    } />
                    <Route path="/director/rapoarte" element={
                        <AuthGuard roluriPermise={['Director']}>
                            <RapoartePDF />
                        </AuthGuard>
                    } />
                    <Route path="/director/notificari" element={
                        <AuthGuard roluriPermise={['Director']}>
                            <NotificariPanel />
                        </AuthGuard>
                    } />
                    ...
                    <Route path="/client/masina/:id" element={
                        <AuthGuard roluriPermise={['Client', 'Director']}>
                            <PaginaMasina />
                        </AuthGuard>
                    } />
                    ...
                    <Route path="/client/simulare-credit" element={
                        <AuthGuard roluriPermise={['Client']}>
                            <SimulareCredit />
                        </AuthGuard>
                    } />
                    <Route path="/client/recomandare-ai" element={
                        <AuthGuard roluriPermise={['Client']}>
                            <RecomandareAI />
                        </AuthGuard>
                    } />
                    ...
                    <Route path="/mecanic/piese" element={
                        <AuthGuard roluriPermise={['Mecanic']}>
                            <GestiunePiese />
                        </AuthGuard>
                    } />
                    <Route path="/mecanic/reparatii" element={
                        <AuthGuard roluriPermise={['Mecanic']}>
                            <ReparatiiMecanic />
                        </AuthGuard>
                    } />
                    <Route path="/mecanic/fisa-reparatie" element={
                        <AuthGuard roluriPermise={['Mecanic']}>
                            <FisaReparatiePDF />
                        </AuthGuard>
                    } />
                    ...
                    {/* Acces interzis */}
                    <Route path="/acces-interzis" element={
                        <Placeholder title="Acces Interzis" description="Nu ai permisiunea să accesezi această pagină." icon="block" />
                    } />

                    {/* 404 */}
                    <Route path="*" element={
                        <Placeholder title="404" description="Pagina nu a fost găsită." icon="search_off" />
                    } />
                </Routes>
            </BrowserRouter>
        </Provider>
