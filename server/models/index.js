...
import createNotificareModel from "./notificare.js";
...
const Notificare = createNotificareModel(sequelize);

// Tabela de jonctiune Piesa_Reparatie (N:M)
const PiesaReparatie = sequelize.define(
  "PiesaReparatie",
  {},
  {
...
Utilizator.hasMany(TestDrive, {
  foreignKey: "idClient",
  as: "testDriveSolicitari",
});
...
Utilizator.hasMany(Tranzactie, {
  foreignKey: "idClient",
  as: "tranzactiiClient",
});
Tranzactie.belongsTo(Utilizator, {
  foreignKey: "idClient",
  as: "clientTranzactie",
});
...
Utilizator.hasMany(Tranzactie, {
  foreignKey: "idDirector",
  as: "tranzactiiAprobate",
});
Tranzactie.belongsTo(Utilizator, {
  foreignKey: "idDirector",
  as: "directorTranzactie",
});
...
// Notificari — legatura cu Reparatie si Utilizator (expeditor + destinatar)
Reparatie.hasMany(Notificare, { foreignKey: "idReparatie", as: "notificari" });
Notificare.belongsTo(Reparatie, { foreignKey: "idReparatie" });
Utilizator.hasMany(Notificare, {
  foreignKey: "idExpeditor",
  as: "notificariTrimise",
});
Notificare.belongsTo(Utilizator, {
  foreignKey: "idExpeditor",
  as: "expeditor",
});
Utilizator.hasMany(Notificare, {
  foreignKey: "idDestinatarUtilizator",
  as: "notificariPrimite",
});
Notificare.belongsTo(Utilizator, {
  foreignKey: "idDestinatarUtilizator",
  as: "destinatar",
